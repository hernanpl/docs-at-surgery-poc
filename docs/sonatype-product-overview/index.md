...
The following table shows how our solutions map to the underlying products:
...
Information for organizations preparing to deploy IPv6 with Sonatype products.

IPv6 is designed to eventually replace the IPv4 protocol. Organizations transitioning to IPv6 need to ensure continued compatibility with Sonatype products.

**→ [IPv6 Readiness Information](ipv6-readiness/)**
...
Sonatype Nexus Repository Manager OSS™, Nexus Repository Manager Pro™, Sonatype Lifecycle™, Sonatype Auditor™, Sonatype Repository Firewall™, IQ Server™, and all Nexus-related logos as well as Sonatype CLM are trademarks or registered trademarks of Sonatype, Inc., in the United States and other countries.
...
Definitions and explanations of key terms used throughout Sonatype documentation.
